...
alias jmd-repl1="mkdir -p repldata1 && gdb -ex r --args ./mongod --replSet johnrs --gdb --dbpath repldata1 --port 28000"
alias jmd-repl2="mkdir -p repldata2 && gdb -ex r --args ./mongod --replSet johnrs --gdb --dbpath repldata2 --port 28001"
